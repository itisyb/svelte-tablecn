...
describe('non-README parity docs', () => {
	...
	it('records shipped shortcut, primitive, and select-editor parity work outside the README', () => {
		for (const phrase of [
			...
			'2px cell-editor radius instead of the shared select content radius',
			'2px cell-editor radius while keeping the upstream width and offset alignment',
		...
		expect(parityPlan).toContain('2px-radius cell-editor content surface');
		expect(parityPlan).toContain('2px-radius cell-editor surface');
